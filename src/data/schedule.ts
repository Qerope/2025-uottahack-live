...
const registrationEvent: IEvent = {
	...
	start: new Date('2024-01-17T17:00:00-05:00'),
	duration: 180,
...
const dinnerEvent: IEvent = {
	...
	start: new Date('2024-01-17T18:00:00-05:00'),
	duration: 90,
...
const openingCeremonyEvent: IEvent = {
	...
	start: new Date('2024-01-17T20:00:00-05:00'),
	duration: 90,
	category: EventCategory.Main,
...
const careerFairEvent: IEvent = {
	...
	start: new Date('2024-01-17T21:30:00-05:00'),
	duration: 120,
...
const hackingBeginsEvent: IEvent = {
	...
	duration: 0,
	start: new Date('2024-01-17T23:00:00-05:00'),
	category: EventCategory.Main,
...
const midnightSnackEvent: IEvent = {
	...
	start: new Date('2024-01-18T00:00:00-05:00'),
	duration: 90,
	category: EventCategory.Food,
	location: Location.FoodC309,
...
const breakfastEvent: IEvent = {
	...
	start: new Date('2024-01-18T07:00:00-05:00'),
	duration: 90,
	category: EventCategory.Food,
	location: Location.FoodC309,
...
const caffeineCafeEvent: IEvent = {
	...
	start: new Date('2024-01-18T11:00:00-05:00'),
	duration: 60,
	category: EventCategory.Food,
...
const lunchEvent: IEvent = {
	...
	start: new Date('2024-01-18T12:00:00-05:00'),
	duration: 90,
	category: EventCategory.Food,
	location: Location.FoodC309,
...
const karaokeEvent: IEvent = {
	...
	start: new Date('2024-01-18T21:30:00-05:00'),
	duration: 105,
	category: EventCategory.Activity1,
	location: Location.RestRoomFloor5,
...
const closingCeremoniesEvent: IEvent = {
	...
	start: new Date('2024-01-19T14:30:00-05:00'),
	duration: 60,
	category: EventCategory.Main,
	location: Location.UCUAuditorium,
...
const hackingEndsEvent: IEvent = {
	...
	start: new Date('2024-01-19T10:00:00-05:00'),
	duration: 0,
	category: EventCategory.Main,
...
const demosEvent: IEvent = {
	...
	start: new Date('2024-01-19T11:00:00-05:00'),
	duration: 150,
	category: EventCategory.Main,
...
const finalLunchEvent: IEvent = {
	...
	start: new Date('2024-01-19T13:00:00-05:00'),
	duration: 90,
	category: EventCategory.Food,
	location: Location.FoodC309,
...
const firstEventDay: IEventDay = {
	...
	events: [
		...
		dinnerEvent, // 🍽️ Dinner Time
		openingCeremonyEvent, // 🎤 Opening Ceremony
		careerFairEvent, // 💼 Career Fair
		teamFormationEvent, // 🤝 Team Formation
		hackingBeginsEvent // 💻 Hack Begins
	]
};
...
const secondEventDay: IEventDay = {
	...
	events: [
		midnightSnackEvent, // 🌙 Midnight Snack
		breakfastEvent, // 🍳 Breakfast Time
		caffeineCafeEvent, // ☕ Caffeine Café
		workshopEvent, // 🛠️ Workshop Time
		careerFairEvent, // 💼 Career Fair
		lunchEvent, // 🍔 Lunchtime
		petTherapyEvent, // 🐶 Pet Therapy
		dinnerEvent, // 🍕 Dinner Time
		workshopEvent, // 🛠️ Workshop Time
		midnightSnackEvent, // 🌙 Midnight Snack
		karaokeEvent // 🎤 Karaoke Fun!
	]
};
...
const thirdEventDay: IEventDay = {
	...
	events: [
		midnightSnackEvent, // 🌙 Midnight Snack
		breakfastEvent, // 🍳 Breakfast Time
		hackingEndsEvent, // ⏰ Hacking Ends
		demosEvent, // 🎬 Demos Time
		finalLunchEvent, // 🍴 Final Lunch
		closingCeremoniesEvent // 🎉 Closing Ceremonies
	]
};
